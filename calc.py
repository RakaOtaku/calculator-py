...
class calculator:
    def __init__(self):
        ...
        # total expression (top number)
        self.total_expression = ""
        # bottom number (big number)
        self.current_expression = ""
        self.display_frame = self.create_display_frame()

        self.total_label, self.label = self.create_display__labels()
    ...
    def create_operator_buttons(self):
        ...
        for operator, symbol in self.operations.items():
            button = tk.Button(self.buttons_frame, text=symbol, bg=OFF_WHITE,
                               fg=LABEL_COLOR, font=DEFAULT_FONT_SYTLE, borderwidth=0, command=lambda x=operator: self.append_operator(x))
    ...
    def create_clear_button(self):
        button = tk.Button(self.buttons_frame, text="C", bg=OFF_WHITE,
                           fg=LABEL_COLOR, font=DEFAULT_FONT_SYTLE, borderwidth=0, command=self.clear)
    ...
    def create_square_button(self):
        button = tk.Button(self.buttons_frame, text="x\u00b2", bg=OFF_WHITE,
                           fg=LABEL_COLOR, font=DEFAULT_FONT_SYTLE, borderwidth=0, command=self.square)
    ...
    def create_sqrt_button(self):
        button = tk.Button(self.buttons_frame, text="\u221ax", bg=OFF_WHITE,
                           fg=LABEL_COLOR, font=DEFAULT_FONT_SYTLE, borderwidth=0, command=self.sqrt)
